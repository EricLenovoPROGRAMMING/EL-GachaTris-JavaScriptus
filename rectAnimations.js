 ...
 * 
 */
function rectAnimationsSet(){
 this.a=rectAniCtx
 this.b=rectAniCanvas
...
$d('rectAnimations').style.transform=`rotateX(${rectRotateTranslation(this.count.x,this.count.y)})`
}
}
}
},
...
var rectAnimations=new rectAnimationsSet()
