...
Preview2.prototype.init = function() {
...
Preview2.prototype.next = function() {
  ...
  //if(pieces2Set<0)
  //gtrisAIPredictor.eval(this.grabBag[0])
 ...
 */
/*Preview2.prototype.gen = function() {
...
/*  if(gameparams && gameparams.pieceSet){
  ...
  if(gametype!==0){
    pieceList= /*/**/[0,1,2,3,4,5,6];/**//*[0,0,0,0,0]/**/
  }else{
   pieceList=  {
     0: [0, 1, 2, 3, 4, 5, 6],
     1: [0, 0, 0, 0, 0, 0, 0],
  ...
  for (var i=0;i<pieceList.length-1;i++)
  {
    ...
    var rand=~~((pieceList.length-i)*rngp2.next())+i;
...
/**
 * Draws the piece Preview2.
 */
Preview2.prototype.draw = function() {
  clear(preview2Ctx);
  clear(preview2Ctx2)
